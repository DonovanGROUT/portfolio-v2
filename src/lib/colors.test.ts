...
describe('Colors Module - Design System', () => {
  describe('Primary Colors', () => {
    it.concurrent(
      'devrait définir le jeu complet de couleurs primaires',
      () => {
    ...
    it.concurrent('devrait avoir des valeurs hexadécimales valides', () => {
  ...
  describe('Secondary Colors', () => {
    it.concurrent(
      'devrait définir le jeu complet de couleurs secondaires',
      () => {
  ...
  describe('Semantic Colors', () => {
    it.concurrent('devrait définir toutes les catégories sémantiques', () => {
    ...
    it.concurrent('devrait définir les variantes pour success', () => {
    ...
    it.concurrent('devrait définir les variantes pour error', () => {
  ...
  describe('Accessibility Configuration', () => {
    it.concurrent(
      "devrait définir les couleurs pour l'accessibilité WCAG",
      () => {
  ...
  describe('Tailwind Colors', () => {
    it.concurrent(
      'devrait mapper correctement les couleurs pour Tailwind',
      () => {
  ...
  describe('Theme Colors', () => {
    it.concurrent('devrait définir les couleurs thématiques', () => {
